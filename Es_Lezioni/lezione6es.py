...
class Restaurant:
    ...
    def describe_restaurant(self):
        print(self.restaurant,self.cuisine)
    
    def open_restaurant(self):
        print("The restaurant is open")

    def set_number_served(self, people_served:int = 0):
        self.number_served = people_served

    def increment_number_served(self, new_served:int):
        self.number_served += new_served

ristorante1 = Restaurant("Nome1", "Tipo1")
...
print("\n9.2")
ristorante2 = Restaurant("Nome2", "Tipo2")
ristorante3 = Restaurant("Nome3", "Tipo3")
ristorante4 = Restaurant("Nome4", "Tipo4")
...
class User:
    ...
    def __init__(self, first_name:str, last_name:str, age:int, gender:str, login_attempts:int = 0) -> None:
    ...
    def greet_user(self):
        print(f"Complimenti {self.name}, sei un grande")
...
user1 = User("Nome1","Cognome1",20,"M")
user2 = User("Nome2","Cognome2",12,"F")
user3 = User("Nome3","Cognome3",29,"?")
user4 = User("Nome4","Cognome4",48,"M")
user1.describe_user()
user1.greet_user()
user2.describe_user()
user2.greet_user()
...
def set_number_served(self, people_served):
    set_number_served += people_served    
"""
ristorante1.set_number_served(12)
print(f"Set number prova {ristorante1.number_served}")
"""
def increment_number-served(self, new_served:int):
    self.number_served += new_Served
"""
ristorante1.increment_number_served(238)
print(f"increment number prova {ristorante1.number_served}")
...
print("\n9.5")
"""
def increment_logi_attempts(self):
    self.login_attempts += 1    
"""
user1.increment_login_attempts()
print(f"Prova increment {user1.login_attempts}")
"""
def reset_login_attempts(self):
    self.login_attempts = 0
"""
user1.reset_login_attempts()
print(f"Prova reset {user1.login_attempts}")
...
class IceCreamStand:
    ...
    def flavors_on_display(self):
        print(self.flavors)

gelato1 = IceCreamStand(["gusto1","gusto2","gusto3"])
gelato1.flavors_on_display()
...
class Admin(User):
    ...
    #def show_privileges(self):
        #print(f"Questi sono i privilegi dell'admin:{self.privileges}")
"""
#admin1 = Admin("NomeA1","CognomeA1",58,"M")
...
admin2 = Admin("NomeA2","CognomeA2",40,"F")
...
ciao = restaurant("ciao","ciao")
ciao.conta_clienti(5)
...
class Dice:
    ...
    def roll_die(self):
        roll = random.randint(0,self.sides)
        print(roll)
...
print("\n9.14")
list_of_numb_int: list = [1, 2, 3, 4, 5, 6, 7, 8, 9, 0, "a", "b", "c", "d", "e"]

lucky_list: list  =  list_of_numb_int[2:15:3]
print(f"I numeri fortunati sono {lucky_list}")
...
print("\n9.15")
counter: int = 0
counterList : int = len(list_of_numb_int)

while counterList > 0:
    for i in list_of_numb_int:
        if i in lucky_list:
            print(f"Hia vinto e ci hai messo:{counter} tentativi")
            counterList -=1
        elif i not in  lucky_list:
            counter += 1
            counterList -=1
